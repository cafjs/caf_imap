...
//HACK STARTS HERE, DON'T BLAME ORIGINAL...

    fromCharset = (fromCharset === "ISO-8859-1" ? 'windows-1252' : fromCharset);
    value = iconv.fromEncoding(value, fromCharset);
    value = iconv.toEncoding(value, toCharset);
...
//HACK ENDS HERE, DON'T BLAME ORIGINAL...
    return value;
};
