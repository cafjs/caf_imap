...
/*
 * NOTE: THIS FILE HAS BEEN (BADLY) MODIFIED TO USE ICONV-LITE. USE AT
 * YOUR OWN RISK AND DO NOT BLAME ANDRIS...
 *
 *
 */
...
// HACK STARTS
    charset = (charset === "ISO-8859-1" ? 'windows-1252' : charset);


    try{
//        iconv = new Iconv(charset, 'UTF-8//TRANSLIT//IGNORE');
        buffer = iconv.fromEncoding(buffer, charset);
        buffer = iconv.toEncoding(buffer, "utf8");
    }catch(E){
        console.log("GOT CHARSET exception" + E);
    }
...
// HACK STARTS
    charset = (charset === "ISO-8859-1" ? 'windows-1252' : charset);
    buffer = (buffer instanceof Buffer) ? buffer.toString("utf-8") : buffer;

    try{
        buffer = iconv.toEncoding(buffer, "charset");
        return buffer;
    }catch(E){
        return buffer;
    }
